...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 55 terms with ISO 11179 compliant definitions |
| FAQ page | :white_check_mark: | Medium | 72 answers to common student questions |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 23 browser-based apps for hands-on learning |
