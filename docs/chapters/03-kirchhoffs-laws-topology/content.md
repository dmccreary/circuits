...
<iframe src="../../../sims/kcl-node-viz/main.html" width="100%" height="595px" scrolling="no" style="border:none; border-radius:8px; overflow:hidden;"></iframe>
</div>
...
<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 18px; margin: 1rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);">
<iframe src="../../../sims/kvl-loop-walkthrough/main.html" width="100%" height="630px" scrolling="no" style="border:none; border-radius:8px; overflow:hidden;"></iframe>
</div>
...
<p style="color: #555; line-height: 1.9; font-size: 1.02rem; margin-bottom: 1.4rem;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin: 1.5rem 0 1.2rem 0;">

<div style="background: #fff; border-left: 5px solid #388E3C; border-radius: 0 8px 8px 0; padding: 20px 24px; box-shadow: 0 2px 8px rgba(56,142,60,0.10);">
<div style="font-weight: 700; color: #1B5E20; font-size: 1.05rem; margin-bottom: 9px;">Node</div>
<div style="color: #444; line-height: 1.75; font-size: 0.96rem;">A point where two or more circuit elements connect. Every node has a single, well-defined voltage.</div>
</div>

<div style="background: #fff; border-left: 5px solid #1976D2; border-radius: 0 8px 8px 0; padding: 20px 24px; box-shadow: 0 2px 8px rgba(25,118,210,0.10);">
<div style="font-weight: 700; color: #0D47A1; font-size: 1.05rem; margin-bottom: 9px;">Branch</div>
<div style="color: #444; line-height: 1.75; font-size: 0.96rem;">A single path between two nodes containing exactly one element — a resistor, source, or wire.</div>
</div>

<div style="background: #fff; border-left: 5px solid #E65100; border-radius: 0 8px 8px 0; padding: 20px 24px; box-shadow: 0 2px 8px rgba(230,81,0,0.10);">
<div style="font-weight: 700; color: #BF360C; font-size: 1.05rem; margin-bottom: 9px;">Loop</div>
<div style="color: #444; line-height: 1.75; font-size: 0.96rem;">Any closed path through the circuit — starting and ending at the same node, visiting no node more than once.</div>
</div>

<div style="background: #fff; border-left: 5px solid #7B1FA2; border-radius: 0 8px 8px 0; padding: 20px 24px; box-shadow: 0 2px 8px rgba(123,31,162,0.10);">
<div style="font-weight: 700; color: #4A148C; font-size: 1.05rem; margin-bottom: 9px;">Mesh</div>
<div style="color: #444; line-height: 1.75; font-size: 0.96rem;">A minimal loop — one that contains no smaller loops inside it. Planar circuits can always be divided into meshes.</div>
</div>

</div>

<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 20px 16px 16px 16px; margin: 0.5rem 0 1.5rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);">
<p style="font-weight: 700; color: #1A237E; font-size: 0.92rem; margin: 0 0 14px 0; text-align: center; letter-spacing: 0.04em; text-transform: uppercase;">Topology Reference Diagram</p>
<svg viewBox="0 0 480 210" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block;margin:0 auto;" aria-label="Circuit topology diagram showing 4 nodes, 5 branches, 2 meshes, and an outer loop">
  <polygon points="80,100 230,40 230,160" fill="rgba(57,73,171,0.10)" stroke="none"/>
  <polygon points="230,40 390,100 230,160" fill="rgba(92,107,192,0.07)" stroke="none"/>
  <line x1="80" y1="100" x2="230" y2="40"  stroke="#37474f" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="80" y1="100" x2="230" y2="160" stroke="#37474f" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="230" y1="40"  x2="230" y2="160" stroke="#37474f" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="230" y1="40"  x2="390" y2="100" stroke="#37474f" stroke-width="2.5" stroke-linecap="round"/>
  <line x1="230" y1="160" x2="390" y2="100" stroke="#37474f" stroke-width="2.5" stroke-linecap="round"/>
  <circle cx="80"  cy="100" r="6.5" fill="#1B5E20"/>
  <circle cx="230" cy="40"  r="6.5" fill="#1B5E20"/>
  <circle cx="230" cy="160" r="6.5" fill="#1B5E20"/>
  <circle cx="390" cy="100" r="6.5" fill="#1B5E20"/>
  <text x="163" y="108" text-anchor="middle" font-size="12" fill="#4A148C" font-weight="600" font-family="Arial,sans-serif">Mesh 1</text>
  <text x="308" y="108" text-anchor="middle" font-size="12" fill="#4A148C" font-weight="600" font-family="Arial,sans-serif">Mesh 2</text>
  <text x="237" y="200" text-anchor="middle" font-size="10.5" fill="#BF360C" font-style="italic" font-family="Arial,sans-serif">&#8635; Outer Loop — spans both meshes, so it is not a mesh itself</text>
  <line x1="46" y1="74" x2="73" y2="95" stroke="#1B5E20" stroke-width="1.3" stroke-dasharray="4,2"/>
  <text x="38" y="69" text-anchor="middle" font-size="11" fill="#1B5E20" font-weight="700" font-family="Arial,sans-serif">Node</text>
  <line x1="134" y1="88" x2="148" y2="76" stroke="#0D47A1" stroke-width="1.3" stroke-dasharray="4,2"/>
  <text x="118" y="100" text-anchor="middle" font-size="11" fill="#0D47A1" font-weight="700" font-family="Arial,sans-serif">Branch</text>
</svg>
<div style="display:flex;gap:28px;justify-content:center;flex-wrap:wrap;margin-top:12px;">
<span style="font-size:0.9rem;color:#1B5E20;">&#9679; Node</span>
<span style="font-size:0.9rem;color:#0D47A1;">&#9135; Branch</span>
<span style="font-size:0.9rem;color:#4A148C;">&#9632; Mesh (minimal loop)</span>
<span style="font-size:0.9rem;color:#BF360C;">&#8635; Loop (any closed path)</span>
</div>
</div>

### The Topology Formula

<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 22px 28px 20px 28px; margin: 1.2rem 0 1.4rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);" markdown>

<p style="font-size: 0.78rem; font-weight: 700; color: #3949AB; letter-spacing: 0.09em; text-transform: uppercase; margin: 0 0 14px 0; border-bottom: 1px solid #C5CAE9; padding-bottom: 8px;">Key Formula &mdash; Topology Relationship</p>

<div style="font-size: 1.45rem; text-align: center; margin: 4px 0 6px 0;">
...
<div style="background: #E3F2FD; border: 1.5px solid #90CAF9; border-radius: 8px; padding: 9px 20px; text-align: center; min-width: 80px;">
<div style="font-weight: 700; color: #0D47A1; font-size: 1.2rem; font-style: italic; line-height: 1;">b</div>
<div style="color: #555; font-size: 0.8rem; margin-top: 4px; line-height: 1.3;">number of<br>branches</div>
</div>
<div style="background: #E8F5E9; border: 1.5px solid #A5D6A7; border-radius: 8px; padding: 9px 20px; text-align: center; min-width: 80px;">
<div style="font-weight: 700; color: #1B5E20; font-size: 1.2rem; font-style: italic; line-height: 1;">n</div>
<div style="color: #555; font-size: 0.8rem; margin-top: 4px; line-height: 1.3;">number of<br>nodes</div>
</div>
<div style="background: #F3E5F5; border: 1.5px solid #CE93D8; border-radius: 8px; padding: 9px 20px; text-align: center; min-width: 80px;">
<div style="font-weight: 700; color: #4A148C; font-size: 1.2rem; font-style: italic; line-height: 1;">m</div>
<div style="color: #555; font-size: 0.8rem; margin-top: 4px; line-height: 1.3;">independent<br>meshes</div>
</div>
</div>

</div>

<p style="color: #555; line-height: 1.9; font-size: 1.02rem; margin-bottom: 1.2rem;">
This relationship holds for any connected planar circuit. <strong>Branches</strong> (<span class="arithmatex">\(b\)</span>) are the individual element paths between nodes; <strong>nodes</strong> (<span class="arithmatex">\(n\)</span>) are the junction points where elements meet; <strong>independent meshes</strong> (<span class="arithmatex">\(m\)</span>) are the minimal loops that tile the circuit. Applying KCL at each non-reference node yields <span class="arithmatex">\(n-1\)</span> independent equations; applying KVL around each mesh yields <span class="arithmatex">\(m\)</span> independent equations — together forming a complete, solvable system.
</p>

#### Diagram: Circuit Topology Explorer

<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 18px; margin: 1rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);">
<iframe src="../../../sims/circuit-topology-explorer/main.html" width="100%" height="595px" scrolling="no" style="border:none; border-radius:8px; overflow:hidden;"></iframe>
</div>
...
<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 18px; margin: 1rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);">
<iframe src="../../../sims/superposition-demo/main.html" width="100%" height="595px" scrolling="no" style="border:none; border-radius:8px; overflow:hidden;"></iframe>
</div>
