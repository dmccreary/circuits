...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 14px; margin: 1.5rem 0 1rem 0;">

<div style="background: #fff; border-left: 4px solid #3949AB; border-radius: 0 8px 8px 0; padding: 16px 20px; box-shadow: 0 2px 6px rgba(57,73,171,0.10);">
<div style="font-weight: 700; color: #1A237E; font-size: 1.05rem; margin-bottom: 7px;">Node</div>
<div style="color: #555; line-height: 1.65; font-size: 0.96rem;">A point where two or more circuit elements connect. Every node has a single, well-defined voltage.</div>
</div>

<div style="background: #fff; border-left: 4px solid #3949AB; border-radius: 0 8px 8px 0; padding: 16px 20px; box-shadow: 0 2px 6px rgba(57,73,171,0.10);">
<div style="font-weight: 700; color: #1A237E; font-size: 1.05rem; margin-bottom: 7px;">Branch</div>
<div style="color: #555; line-height: 1.65; font-size: 0.96rem;">A single path between two nodes containing exactly one element — a resistor, source, or wire.</div>
</div>

<div style="background: #fff; border-left: 4px solid #3949AB; border-radius: 0 8px 8px 0; padding: 16px 20px; box-shadow: 0 2px 6px rgba(57,73,171,0.10);">
<div style="font-weight: 700; color: #1A237E; font-size: 1.05rem; margin-bottom: 7px;">Loop</div>
<div style="color: #555; line-height: 1.65; font-size: 0.96rem;">Any closed path through the circuit — starting and ending at the same node, visiting no node more than once.</div>
</div>

<div style="background: #fff; border-left: 4px solid #5C6BC0; border-radius: 0 8px 8px 0; padding: 16px 20px; box-shadow: 0 2px 6px rgba(57,73,171,0.10);">
<div style="font-weight: 700; color: #1A237E; font-size: 1.05rem; margin-bottom: 7px;">Mesh</div>
<div style="color: #555; line-height: 1.65; font-size: 0.96rem;">A minimal loop — one that contains no smaller loops inside it. Planar circuits can always be divided into meshes.</div>
</div>

</div>

<div style="background: #EEF4FF; border: 2px solid #A8C8FF; border-radius: 12px; padding: 20px 24px 16px 24px; margin: 0.5rem 0 1.5rem 0; box-shadow: 0 2px 8px rgba(90,61,237,0.07);">
...
<svg viewBox="0 0 480 210" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:480px;display:block;margin:0 auto;" aria-label="Circuit topology diagram showing 4 nodes, 5 branches, 2 meshes, and an outer loop">
  ...
  <circle cx="80"  cy="100" r="6.5" fill="#1A237E"/>
  <circle cx="230" cy="40"  r="6.5" fill="#1A237E"/>
  <circle cx="230" cy="160" r="6.5" fill="#1A237E"/>
  <circle cx="390" cy="100" r="6.5" fill="#1A237E"/>
  <text x="163" y="108" text-anchor="middle" font-size="12" fill="#3949AB" font-weight="600" font-family="Arial,sans-serif">Mesh 1</text>
  <text x="308" y="108" text-anchor="middle" font-size="12" fill="#5C6BC0" font-weight="600" font-family="Arial,sans-serif">Mesh 2</text>
  <text x="237" y="200" text-anchor="middle" font-size="10.5" fill="#795548" font-style="italic" font-family="Arial,sans-serif">&#8635; Outer Loop — spans both meshes, so it is not a mesh itself</text>
  ...
  <line x1="134" y1="88" x2="148" y2="76" stroke="#B71C1C" stroke-width="1.3" stroke-dasharray="4,2"/>
  <text x="118" y="100" text-anchor="middle" font-size="11" fill="#B71C1C" font-weight="700" font-family="Arial,sans-serif">Branch</text>
</svg>
<div style="display:flex;gap:20px;justify-content:center;flex-wrap:wrap;margin-top:10px;">
<span style="font-size:0.84rem;color:#1B5E20;">&#9679; Node</span>
<span style="font-size:0.84rem;color:#37474f;">&#9135; Branch</span>
<span style="font-size:0.84rem;color:#3949AB;">&#9632; Mesh (minimal loop)</span>
<span style="font-size:0.84rem;color:#795548;">&#8635; Loop (any closed path)</span>
</div>
</div>
