...
A) A time-domain sinusoidal function &emsp; B) A complex number representing the amplitude and phase of a sinusoid &emsp; C) The derivative of a sinusoidal signal &emsp; D) A rotating vector that varies with time

---

**2. What is the impedance of a capacitor \(C\) at angular frequency \(\omega\)?**

A) \(j\omega C\) &emsp; B) \(\omega C\) &emsp; C) \(\dfrac{1}{j\omega C}\) &emsp; D) \(j\omega L\)

---

**3. What is the impedance of an ideal inductor \(L\) at angular frequency \(\omega\)?**

A) \(\dfrac{1}{j\omega L}\) &emsp; B) \(j\omega L\) &emsp; C) \(\omega L\) &emsp; D) \(\dfrac{1}{\omega L}\)

---

**4. A series RLC circuit has \(X_L > X_C\) at a given frequency. The circuit behaves:**

A) Capacitively — current leads voltage &emsp; B) Resistively — no phase shift &emsp; C) Inductively — voltage leads current &emsp; D) As if at resonance

---

**5. In the impedance triangle, if resistance is \(R\) and net reactance is \(X\), what is \(|Z|\)?**

A) \(R + X\) &emsp; B) \(R/X\) &emsp; C) \(R^2 + X^2\) &emsp; D) \(\sqrt{R^2 + X^2}\)

---

**6. What happens to capacitive reactance \(X_C\) as frequency increases?**

A) Increases proportionally &emsp; B) Remains constant &emsp; C) Decreases &emsp; D) Becomes negative

---

**7. For a pure resistor in an AC circuit, the phase relationship between voltage and current is:**

A) Voltage leads current by 90° &emsp; B) Current leads voltage by 90° &emsp; C) In phase (0°) &emsp; D) Voltage leads by 45°

---

**8. A 10 mH inductor operates at \(f = 5\) kHz. What is its inductive reactance \(X_L\)?**

A) 50 Ω &emsp; B) 314 Ω &emsp; C) 628 Ω &emsp; D) 3,142 Ω

---

**9. Phasor analysis is valid when:**

A) All sources are DC &emsp; B) The circuit has only resistors &emsp; C) All sources are sinusoidal at the same frequency in steady state &emsp; D) The circuit is in a transient switching state

---

**10. At series resonance, the total impedance of the RLC circuit equals:**

A) Zero &emsp; B) \(X_L\) &emsp; C) \(R\) &emsp; D) \(X_L + X_C\)
...
| 5 | D | Pythagorean theorem on the impedance triangle: \(|Z| = \sqrt{R^2+X^2}\) |
