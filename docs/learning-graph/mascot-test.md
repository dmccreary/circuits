...
!!! mascot-welcome "Sparky's Welcome"
    <img src="../../img/mascots/welcome.png" class="mascot-admonition-img" alt="Sparky welcoming">
...
!!! mascot-thinking "Sparky Thinking"
    <img src="../../img/mascots/thinking.png" class="mascot-admonition-img" alt="Sparky thinking">
...
!!! mascot-warning "Sparky's Warning"
    <img src="../../img/mascots/warning.png" class="mascot-admonition-img" alt="Sparky warning">
...
1. Neutral
![](../img/mascots/neutral.png){ width="150px"}
2. Welcome
![](../img/mascots/welcome.png){ width="150px"}
3. Thinking
![](../img/mascots/thinking.png){ width="150px"}
4. Tip
![](../img/mascots/tip.png){ width="150px"}
5. Gentle Warning
![](../img/mascots/warning.png){ width="150px"}
6. Encouraging
![](../img/mascots/encouraging.png){ width="150px"}
7. Celebration
![](../img/mascots/celebration.png){ width="150px"}
</div>