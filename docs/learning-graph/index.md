...
- **Dependencies (Edges)**: 627
- **Taxonomy Categories**: 12
- **Longest Learning Path**: 21 concepts
...
- Validates course description has sufficient depth for generating concepts
...
- Longest dependency chains: 21 concepts
...
- Category organization - foundational elements first, advanced applications last
- Balanced categories (6.7% - 10% each)
