...
| Glossary Terms | 54 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 0 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 0 | - | Questions across all chapters |
| MicroSims | 18 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Equations | 54 | 0 | LaTeX expressions (inline and display) |
| Total Words | 20,991 | 3,181 | Words in markdown files |
| Links | 236 | 42 | Hyperlinks in markdown format |
| Equivalent Pages | 92 | 21 | Estimated pages (250 words/page + visuals) |
